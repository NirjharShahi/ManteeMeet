...
console.log("ZEGO_CONFIG loaded as:", ZEGO_CONFIG);
...
export const APP_CONFIG = {
  ...
  APP_NAME: "ManteeMeet",
  APP_DESCRIPTION:
    "Connect, learn, and grow together with ManteeMeet. Host or join interactive sessions with HD video, real-time chat, and seamless collaboration.",
  ...
  SOCIAL_LINKS: {
    ...
    EMAIL: "mailto:support@manteemeet.com",
  },
